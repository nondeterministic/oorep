...
CREATE TABLE CAZESUBRUBRIC(
  ID           SERIAL PRIMARY KEY,
  CAZERUBRICID INT NOT NULL,
  ABBREV       VARCHAR(265) NOT NULL,
  RUBRICID     INT NOT NULL
);
...
DROP TABLE FILE;
DROP TABLE CAZE;
DROP TABLE CAZERUBRIC;
DROP TABLE CAZESUBRUBRIC;
