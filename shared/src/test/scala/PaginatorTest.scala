...
class PaginatorTest extends PlaySpec with GuiceOneAppPerTest with Injecting {
  ...
  s"Pagination with 3 maxActivePages: " should {
    ...
    "page 1/1" in {
      val p = new Paginator(1, 1, maxActivePages)
      val pagination = p.getPagination()
      println(pagination)
    ...
    "page 1/2" in {
      val p = new Paginator(2, 1, maxActivePages)
      val pagination = p.getPagination()
      println(pagination)
    ...
    "page 3/3" in {
      val p = new Paginator(3, 3, maxActivePages)
      val pagination = p.getPagination()
      println(pagination)
    ...
    "page 7/187" in {
      val p = new Paginator(187, 7, maxActivePages)
      val pagination = p.getPagination()
      println(pagination)
      assert(pagination.left.size == 1 && pagination.middle.size == maxActivePages && pagination.right.size == 1)
    }
    ...
    "page 71/187" in {
      val p = new Paginator(187, 71, maxActivePages)
      val pagination = p.getPagination()
      println(pagination)
      assert(pagination.left.size == 1 && pagination.middle.size == maxActivePages && pagination.right.size == 1)
    }
    ...
    "page 187/187" in {
      val p = new Paginator(187, 187, maxActivePages)
      val pagination = p.getPagination()
      println(pagination)
      assert(pagination.left.size == 1 && pagination.middle.size == 0 && pagination.right.size == maxActivePages)
    }
